 ...
 * @since 2020/06/17
 */
public class MavenParserBuilder implements ParserBuilder {
    @Override
    public DependencyParser build(String profile, boolean useGlobalSettings) throws DependencyParserException {
        String settings;
        ...
        return new MavenParser(localRepo, remoteRepo, xmlReader);
    }
